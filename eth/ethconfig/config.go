...
func init() {
	...
	if runtime.GOOS == "darwin" {
		Defaults.Ethash.DatasetDir = filepath.Join(home, "Library", "StorageProtocol")
	} else if runtime.GOOS == "windows" {
		localappdata := os.Getenv("LOCALAPPDATA")
		if localappdata != "" {
			Defaults.Ethash.DatasetDir = filepath.Join(localappdata, "StorageProtocol")
		} else {
			Defaults.Ethash.DatasetDir = filepath.Join(home, "AppData", "Local", "StorageProtocol")
		}
	} else {
		Defaults.Ethash.DatasetDir = filepath.Join(home, ".storageprotocol")
	}
}
